...
public class IncrementalJoin {
    ...
    public static void main(String[] args) throws Exception{
        ...
        List<List<String>> data_file = util.DataReader.getEdgeListFile("increment_test/orig_data.csv",",",true);
        ...
        List<List<String>> increment_file = util.DataReader.getEdgeListFile("increment_test/inc_data.csv",",",true);
